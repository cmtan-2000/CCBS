...
<body class="background">
	...
	<div class="page-wrapper">
		<div class="container">
			...
			<form action="editProfile/success" method="post" enctype="multipart/form-data">
				<div class="row mb-4">
					<div class="col">
				...
				<input type="submit" class="btn btn-success me-4" value="Submit"/>
				<a class="btn btn-secondary" href="/CCBS/profile/${user.getUser_id()}">Cancel</a>
