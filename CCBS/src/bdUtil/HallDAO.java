...
public class HallDAO {
	...
	public int add (Hall hall, InputStream pic) {
		...
		String hallSql = "insert into `hall` (`brch_id`, `hall_type`, `seat_type`, `air_cond`, `sound_sys`, `image`, `hall_condition`, `hall_status`, `hall_seat`) values (?,?,?,?,?,?,?,?,?)";
		Object args[] =  {	hall.getBrch_id(),	hall.getHall_type(), 	hall.getSeat_type(), hall.getAir_cond(), hall.getSound_sys(), hall.getImage(), hall.getHall_condition(), hall.getHall_status(), hall.getHall_seat()};
