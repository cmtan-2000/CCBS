...
public class RegisterController extends HttpServlet {
    ...
    protected ModelAndView clickRegister(@RequestParam("photoFile") MultipartFile photoFile, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	String sql = "insert into `profile`(`username`, `password`, `name`, `type`, `dob`, `phoneNo`, `address`, `securityQType`, `securityQAns`, `photoFile`) values (?,?,?,?,?,?,?,?,?,?)";
    ...
    protected ModelAndView forgotPasswordRecovery(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	String username = request.getParameter("userName");
    		...
    		while(rs.next()) {
				System.out.print(rs.getString("username"));
				 ...
				 if(username.equals(rs.getString("username"))) {
					 if(securityQ.equals(rs.getString("securityQType")) && securityAns.equals(rs.getString("securityQAns"))) {
