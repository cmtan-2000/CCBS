			...
			<div class="row">
				<div class="col">
					<a id="movie1" target="_blank" href="./movieDetail.jsp"> <img
						src="resources/images/Mechamato-poster.jpg" class="movie__poster" /></a>
				</div>
				<div class="col">
					<a id="movie2" target="_blank" href="./movieDetail.jsp"> <img
						src="resources/images/SAO-poster.jpeg" class="movie__poster" /></a>
				</div>
				<div class="col">
					<a id="movie3" target="_blank" href="./movieDetail.jsp"> <img
						src="resources/images/Wakanda-poster.jpg" class="movie__poster" /></a>
				</div>
				<div class="col">
					<a id="movie4" target="_blank" href="./movieDetail.jsp"> <img
						src="resources/images/black-adam-poster.jpg" class="movie__poster" /></a>
				</div>
			</div>
		</div>
	</div>
